# SimplLibraryCRM
Упрощенная система управления информационными ресурсами электронной библиотекой, с возможностью добавления/удаления пользователей, книг, закрепления книг за определенным пользователем.
